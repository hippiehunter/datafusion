...
use datafusion_expr::{
    JsonTable, JsonTableColumnDef, JsonTableErrorHandling,
...
impl<S: ContextProvider> SqlToRel<'_, S> {
    ...
    fn create_default_relation(
        ...
        let (plan, alias) = match relation {
            ...
            // TableFactor::GraphTable removed from sqlparser fork
...
impl<S: ContextProvider> SqlToRel<'_, S> {
    ...
    // Graph table support removed - sqlparser fork no longer has GraphTable types
}
