...
mod tests {
    ...
    use datafusion_expr::{
        ColumnarValue, Extension, LogicalPlanBuilder, ScalarFunctionArgs, ScalarUDF,
        ScalarUDFImpl, Signature, TableSource, TableType, UserDefinedLogicalNodeCore,
        Volatility, col, in_list, in_subquery, lit,
    };
    ...
    // NOTE: Window function filter tests (filter_move_window, filter_window_special_identifier,
    // filter_move_complex_window, filter_move_partial_window, filter_expression_keep_window,
    // filter_order_keep_window, filter_multiple_windows_common_partitions,
    // filter_multiple_windows_disjoint_partitions) were removed because they depend on the
    // datafusion_functions_window crate which has been pruned from this fork.
